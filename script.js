...
const formatCur = function (mov, acc) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    var formatMov = formatCur(mov, acc);
...
const timerr = setInterval(function () {
  let y = new Date();
  const u = Intl.DateTimeFormat(navigator.language, {
    hour: 'numeric',
    minute: 'numeric',
    second: 'numeric',
  }).format(y);
